...
- **SwarmLab evidence gate** — turns replay-verified SwarmLab retests (`RT-01`..`RT-09`) into deterministic release checks and explicitly reports which stack mappings are still pending. This is a release gate, not a learned predictor.
