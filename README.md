...
- **SwarmLab evidence gate** — turns 25 replay-verified SwarmLab retests (`RT-01`..`RT-25`) into deterministic release checks. The current gate is **25/25 passed**, including post-authorization effect commitments, concurrent start fencing, and receipt-bound terminal outcomes. This is a release gate, not a learned predictor.
